            ...
            {allLessonsDone ? (
                ...
                <Card className="shadow-lg hover:shadow-primary/20 transition-shadow">
                    ...
                    <CardContent className="flex flex-col sm:flex-row gap-4 p-4">
                         <Button asChild size="lg" className="flex-1 bg-btn-gradient text-accent-foreground hover:opacity-90 h-64 text-lg">
                            <Link href={`/subjects/${currentLesson.subject.id}/chat`}>
                                Start Lesson
                                <ArrowRight className="ml-2"/>
                            </Link>
                        </Button>
                        <Button size="lg" variant="outline" onClick={handleSkip} className="flex-1 h-64 text-lg">
